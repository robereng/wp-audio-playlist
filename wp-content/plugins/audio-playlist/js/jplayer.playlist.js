...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			listItem += "<input type='range' value='0' step='1' id='backing4' style='display:none'><div class='rateit' data-rateit-backingfld='#backing4' data-rateit-ispreset='true' data-rateit-min='0' data-rateit-max='5'></div>"
			listItem += "</div></li>";
